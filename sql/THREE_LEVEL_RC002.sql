...
-- ----------------------------
ALTER TABLE "HIS"."THREE_LEVEL_RC002" ADD CONSTRAINT "SYS_C0011257" PRIMARY KEY ("THREE_LEVEL_RC001_ID");

-- ----------------------------
-- Checks structure for table THREE_LEVEL_RC002
-- ----------------------------
ALTER TABLE "HIS"."THREE_LEVEL_RC002" ADD CONSTRAINT "SYS_C0011254" CHECK ("THREE_LEVEL_RC001_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HIS"."THREE_LEVEL_RC002" ADD CONSTRAINT "SYS_C0011255" CHECK ("CODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HIS"."THREE_LEVEL_RC002" ADD CONSTRAINT "SYS_C0011256" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
