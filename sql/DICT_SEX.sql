...
-- ----------------------------
ALTER TABLE "HIS"."DICT_SEX" ADD CONSTRAINT "NN_DICT_SEX__SEX_CODE" CHECK ("SEX_CODE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HIS"."DICT_SEX" ADD CONSTRAINT "NN_DICT_SEX__SEX_NAME" CHECK ("SEX_NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
