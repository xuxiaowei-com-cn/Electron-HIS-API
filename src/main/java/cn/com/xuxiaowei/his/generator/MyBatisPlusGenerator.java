package cn.com.xuxiaowei.his.generator;
...
public class MyBatisPlusGenerator {
     ...
     * 数据库 地址
     */
    private String url = "jdbc:p6spy:oracle:thin:@192.168.8.133:11521:helowin";
...
//        <code>templateConfig.setController("/templates/controller2.java");</code>
    ...
    private PackageConfig getPackageConfig() {
        ...
        // 设置 父包名
        packageConfig.setParent("cn.com.xuxiaowei.his");
    ...
    private StrategyConfig getStrategyConfig(PackageConfig packageConfig) {
        ...
        if (ignore.equals(superEntityClass)) {
            ...
            // 自定义继承的Entity类全称，带包名
            superEntityClass = cn.com.xuxiaowei.his.framework.entity.Entity.class.getName();
        }
